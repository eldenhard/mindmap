...
//                 .then(res => {
//                     data = res;
//                     data.forEach(n => (n.value = n.name, delete n.name));
//                     data.map(({ name, ...n }) => (n.value = name, n))
//                     console.log(data);

//                     let data_map = {};
//                     data_map['children'] = data;
//                     data_map['value'] = 'Архитектура'; 

//                     var chart = anychart.wordtree([data_map], "as-tree");
...
var svg = d3.select("#body").append("svg").attr("width", "100%").attr("height", 900)
...
// Положение текста внутри прямоугольников
